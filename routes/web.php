...
Route::post('/item-distributions/{id}/return', [ItemDistributionsController::class, 'return'])->name('item_distributions.return');
...
Route::post('/service-records/{service_record}/undo', [Service_RecordsController::class, 'undoCompletion'])->name('service_records.undo');
