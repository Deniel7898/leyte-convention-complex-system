...
<div class="mt-4">
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4 bg-light rounded-4">
                    ...
                    <div class="modal-content rounded-4 shadow-lg">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div style="font-size: 48px; color: #3b82f6; margin: 1rem 0;">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="none" stroke="#3b82f6" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-target">
                            ...
                            <input type="text" id="manualQrInput" class="form-control mb-3" placeholder="Or enter QR code manually" autocomplete="off" autofocus>

                            <button id="manualSubmit" class="btn w-100 text-white" style="background-color: rgb(43, 45, 87);">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="actionFormContainer" style="display:none; margin-top:20px; border:1px solid #ddd; padding:20px; border-radius:8px;">
    ...
    <div class="mini-card py-3">
        ...
        <div class="activity-item">
            ...
            <div class="activity-dot 
                @if($activity->type == 'received') bg-success
                @elseif($activity->type == 'maintenance') bg-warning
                @elseif($activity->type == 'issued') bg-primary
                @else bg-secondary
                @endif
            "></div>
