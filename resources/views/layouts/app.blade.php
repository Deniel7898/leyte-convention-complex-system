            ...
            <div class="sidebar-header d-flex align-items-center ps-3 pe-3 justify-content-between"
                ...
                <button id="menu-toggle"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                        ...
                        <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5 m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5 m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5-.5" />
                    </svg>
                </button>
            </div>
