<ul>
    ...
    <li class="nav-item ">
        <a href="#" title="{{ __('Inventory') }}">
            ...
            <span class="text">{{ __('Inventory') }}</span>
        </a>
    </li>

    <li class="nav-item ">
        <a href="#" title="{{ __('Distribution') }}">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                    <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z" />
                </svg>
            </span>
            <span class="text">{{ __('Distribution') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item ">
        <a href="#" title="{{ __('Purchase Request') }}">
            <span class="icon">
    ...
    <ul class="nav flex-column" id="sidebarAccordion">
        ...
        <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="dropdown-nav collapse mt-1 ps-4" data-bs-parent="#sidebarAccordion">
                ...
                <li>
                    <a href="{{ route(name: 'units.index') }}" title="{{ __('Units') }}">
                        <span class="icon">
