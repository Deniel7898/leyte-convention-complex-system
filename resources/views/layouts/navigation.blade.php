<ul>
    ...
    <li class="nav-item @if(collect(['item_distributions.*'])->contains(fn($pattern) => request()->routeIs($pattern))) active @endif">
        <a href="{{ route('item_distributions.index') }}" title="{{ __('Item Distribution') }}">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                    <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z" />
                </svg>
            </span>
            <span class="text">{{ __('Item Distribution') }}</span>
        </a>
    </li>

    <li class="nav-item @if(collect(['service_records.*'])->contains(fn($pattern) => request()->routeIs($pattern))) active @endif">
        <a href="{{ route('service_records.index') }}" title="{{ __('Item Installation & Maintenance') }}">
            <span class="icon">
    ...
    <li class="nav-item @if(request()->routeIs('purchase_requests.*')) active @endif">
        <a href="{{ route('purchase_requests.index') }}" title="{{ __('Purchase Request') }}">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
                    <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0" />
                </svg>
            </span>
            <span class="text">{{ __('Purchase Request') }}</span>
        </a>
    </li>
    ...
    <ul class="nav flex-column" id="sidebarAccordion">
        ...
        <li class="nav-item nav-item-has-children">
            <a class="collapsed" href="#0" class="" data-bs-toggle="collapse" data-bs-target="#ddmenu_2"
                aria-controls="ddmenu_2" aria-expanded="false" aria-label="Toggle navigation" title="{{ __('Settings') }}">
                <span class="icon">
            ...
            <ul id="ddmenu_2" data-bs-parent="#sidebarAccordion" class="dropdown-nav collapse mt-1 ps-4 @if(collect(['sync_data.*'])->contains(fn($pattern) => request()->routeIs($pattern))) show @endif">
                <li>
                    <a href="#" title="{{ __('Sync Data') }}">
                        ...
                        <span class="text">{{ __('Sync Data') }}</span>
                    </a>
                </li>
            </ul>
        </li>
