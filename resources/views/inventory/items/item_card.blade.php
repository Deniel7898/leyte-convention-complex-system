<a href="{{ route('inventory.index') }}" class="fw-bold my-4 d-flex align-items-center gap-2" style="color: rgb(43, 45, 87);">
...
<div class="card shadow-lg rounded-4 p-3 mb-3 d-flex flex-column flex-md-row align-items-center gap-4 modern-card"
    ...
    <div class="col-auto">
        <div class="delete" data-url="{{ route('items.destroy', ['item' => $item->id]) }}">
