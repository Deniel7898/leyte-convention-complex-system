<form action="{{ route('service_records.complete_service', $service_record->id) }}" method="POST"
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" value="{{ $service_record->inventory->item->name ?? '' }}"
                    readonly>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" value="{{ $service_record->inventory->qrCode->code ?? 'N/A' }}"
                    readonly>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" id="completed_date" name="completed_date" class="form-control" min="{{ isset($service_record)
    ? \Carbon\Carbon::parse($service_record->service_date)->format('Y-m-d')
    : date('Y-m-d') }}" max="{{ date('Y-m-d') }}" value="{{ old('completed_date', date('Y-m-d')) }}" required>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn text-white" style="background-color: rgb(43, 45, 87);">Complete
            Service</button>
    </div>
</form>