...
<div class="modal-body">
    ...
    : 'N/A' }}
        ...
        <div class="row py-2 border-bottom">
            ...
            <div class="col-8">
                <span
                    class="px-2 rounded border bg-light">{{ $service_record->inventory->qrCode->code ?? 'N/A' }}</span>
            </div>
        ...
        <!-- Person in Charge -->
        <div class="row py-2 border-bottom">
            <div class="col-4 fw-bold" style="color: rgb(43, 45, 87);">Incharge / Technician</div>
        ...
        <div class="row py-2 border-bottom">
            ...
            <div class="col-6 d-flex justify-content-center mt-2">
                @if(isset($service_record) && $service_record->picture)
                    <img src="{{ asset('storage/' . $service_record->picture) }}" class="img-fluid rounded clickableImage"
                        style="max-height: 180px; cursor: pointer;" alt="{{ $service_record->name }} Picture">
                @else
            ...
            <div class="col-6 d-flex justify-content-center mt-2">
                @if(isset($service_record->inventory->qrCode?->qr_picture) && $service_record->inventory->qrCode->qr_picture)
                    <img src="{{ asset('storage/' . $service_record->inventory->qrCode->qr_picture) }}"
                        class="img-fluid rounded clickableImage" style="max-height: 180px; cursor: pointer;"
